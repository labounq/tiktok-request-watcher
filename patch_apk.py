...
def copy_script_temp(apk):
    ...
    src = os.path.join(os.getcwd(), "tiktok-ssl-pinning-bypass-compiled.js")
...
def copy_script_to_arch(script, arch):
...
def main():
    ...
    for arch in archs:
        ...
        copy_script_to_arch(script, arch)
